...
public:
    ...
    //---------------------------------------------------------------------------
    /// Loads the vertex shader from the given file and creates the vertex
    /// shader.
    ...
    //---------------------------------------------------------------------------
    /// Loads the fragment shader combining the given files and creates the
    /// fragment shader.
    /// @param[in]  head    The file containing the shader head.
    ...
    //---------------------------------------------------------------------------
    /// Loads the fragment shader from the given file and creates the fragment
    /// shader.
    /// @param[in]  filename    The file to load.
    /// @return                 False if an error occurred.
    //---------------------------------------------------------------------------
    ...
    /// @param[in]  count   The total count of float components in the given
    /// vector.
    /// @return             False if an error occurred.
    //---------------------------------------------------------------------------
...
private:
    ...
    /// @return             False if an error occurred.
    //---------------------------------------------------------------------------
    static bool MakeShader(unsigned int type, const std::string& text,
                           unsigned int& store);
